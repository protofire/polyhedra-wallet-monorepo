...
const descriptionText = `${BRAND_NAME} is the most trusted smart account wallet on Expchain.`
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://polyhedra-safe.protofire.io/images/social-share.png" />
    <meta name="og:description" content={descriptionText} />
    <meta name="og:title" content={titleText} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@PolyhedraZK" />
    <meta name="twitter:title" content={titleText} />
    <meta name="twitter:description" content={descriptionText} />
    <meta name="twitter:image" content="https://polyhedra-safe.protofire.io/images/social-share.png" />
